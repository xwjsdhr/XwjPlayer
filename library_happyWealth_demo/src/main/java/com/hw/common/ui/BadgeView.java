...
public class BadgeView extends TextView {
	...
	private int DEFAULT_CORNER_RADIUS_DIP = 10;
	...
	private int leftMargin = -9999;
	private int topMargin = -9999;
	private int rightMargin = -9999;
	private int bottomMargin = -9999;
	...
	public int getDEFAULT_CORNER_RADIUS_DIP() {
		return DEFAULT_CORNER_RADIUS_DIP;
	}

	public void setDEFAULT_CORNER_RADIUS_DIP(int dEFAULT_CORNER_RADIUS_DIP) {
		DEFAULT_CORNER_RADIUS_DIP = dEFAULT_CORNER_RADIUS_DIP;
	}
	...
	private void applyLayoutParams() {
		...
		if (StringUtils.isEmpty(getText().toString())) {
			lp = new FrameLayout.LayoutParams(dipToPixels(8), dipToPixels(8));
		} else {
	...
	public void setBadgeMargin(int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
		this.leftMargin = dipToPixels(leftMargin);
		this.topMargin = dipToPixels(topMargin);
		this.rightMargin = dipToPixels(rightMargin);
		this.bottomMargin = dipToPixels(bottomMargin);
	}
