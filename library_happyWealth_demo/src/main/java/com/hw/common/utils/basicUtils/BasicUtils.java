...
public class BasicUtils {
    ...
    public static void iterateHashMap(HashMap hashMap, String classAndMethodName) {
        ...
        MLogUtil.d(classAndMethodName);
        while (iterator.hasNext()) {
            Object obj = iterator.next();
            MLogUtil.d(obj.toString());
            //Method2
//            Map.Entry entry = (Map.Entry) obj;
//            Object key = entry.getKey();
//            Object val = entry.getValue();
//            MLogUtil.d(key.toString());
//            MLogUtil.d(val.toString());
    ...
    public static String getVersionName(Context context) {
        ...
        try {
            ...
            // getPackageName()--your current package name�? means get package info
