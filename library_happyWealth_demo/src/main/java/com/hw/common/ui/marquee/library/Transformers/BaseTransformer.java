 ...
 *
 * BaseTransformer implement {@link com.hw.common.ui.marquee.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.hw.common.ui.marquee.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.hw.common.ui.marquee.library.Animations.BaseAnimationInterface}
 * work.
 *
